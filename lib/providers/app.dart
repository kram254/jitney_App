...
import 'package:jitney_app/models/ride_Request.dart';
import 'package:jitney_app/models/rider.dart';
//import 'package:jitney_app/models/route.dart';
import 'package:jitney_app/models/route.dart';
import 'package:jitney_app/services/map_requests.dart';
import 'package:jitney_app/services/ride_request.dart';
import 'package:jitney_app/services/rider.dart';
import 'package:jitney_app/services/user.dart';
...
//        when its on the background and opened using the notification drawer
  ...
  _getUserLocation() async {
    ...
    List<mark.Placemark> placemark = await Geolocator().placemarkFromCoordinates(position.latitude, position.longitude);
